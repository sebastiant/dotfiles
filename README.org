...
- [[https://gnome.org/][Gnome]] as desktop environment. I used [[https://xmonad.org/][xmonad]] with [[https://dunst-project.org/][dunst]] and [[https://polybar.github.io/][polybar]] until commit #c599745 and I have a branch `nixos-sway` with sway in NixOS. Due to screensharing needs I use Gnome for now.
